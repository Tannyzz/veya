	    ...
	    <nav class="white z-depth-2 bar-nav">
		    <div class="nav-wrapper ">
		      ...
		      <li><a href="index.html" class="indigo-text">Inicio</a></li>
		        ...
		        <li><a href="cursos.html" class="indigo-text">Cursos</a></li>
                ...
                <ul>
                  ...
                  <li><div class="row">
                  		<div class="col s12">
                  				...
                  				<a href="https://twitter.com/VeronEsquivel" ><img width="50px" height="50px" src="images/twitter_f.png" class="responsive-img">
                  		</div>
                  	  </div>
                  </li>
